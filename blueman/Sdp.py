...
uuid_names = {
    ...
    0x0017: _("Audio/Video Control Transport Protocol (AVCTP)"),
    0x0019: _("Audio/Video Distribution Transport Protocol (AVDTP)"),
    0x001b: _("CAPI Message Transport Protocol (CMTP)"),
    0x001d: _("UDI_C-Plane"),
    0x001e: _("Multi-Channel Adaptation Protocol (MCAP)"),
    0x001f: _("Multi-Channel Adaptation Protocol (MCAP)"),
    0x0100: _("Logical Link Control and Adaptation Layer Protocol (L2CAP)"),
    ...
    0x1104: _("Infrared Mobile Communications (IrMC) Sync"),
    ...
    0x1122: _("Basic Printing Profile (BPP)"),
    0x1123: _("Printing Status (BPP)"),
    0x1124: _("Human Interface Device (HID) Service"),
    0x1125: _("HardcopyCableReplacement (HCR)"),
    0x1126: _("HCR_Print (HCR)"),
    0x1127: _("HCR_Scan (HCR)"),
    0x1128: _("Common ISDN Access Profile (CIP)"),
    0x1129: _("VideoConferencingGW (VCP)"),
    0x112a: _("UDI-MT"),
    0x112b: _("UDI-TA"),
    0x112c: _("Audio/Video"),
    0x112d: _("SIM Access Profile (SAP)"),
    0x112e: _("Phone Book Access Profile (PBAP) - Phone Book Client Equipment (PCE)"),
    0x112f: _("Phone Book Access Profile (PBAP) - Phone Book Server Equipment (PSE)"),
    0x1130: _("Phone Book Access Profile (PBAP)"),
    0x1131: _("Headset"),
