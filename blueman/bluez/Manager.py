...
class Manager(GObject.GObject, metaclass=SingletonGObjectMeta):
    ...
    def _on_interface_added(
        self, _object_manager: Gio.DBusObjectManager, dbus_object: Gio.DBusObject, _dbus_interface: Gio.DBusInterface
    ) -> None:
    ...
    def watch_name_owner(
        ...
        Gio.bus_watch_name(
            Gio.BusType.SYSTEM, cls.__bus_name, Gio.BusNameWatcherFlags.AUTO_START, appeared_handler, vanished_handler
        )
