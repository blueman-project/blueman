...
class InfoWindow(Gtk.ApplicationWindow):
    def __init__(self, title: str, object_path: ObjectPath, application: Gtk.Application) -> None:
        ...
        self.__cb_format = builder.get_widget("cb_format", Gtk.ComboBoxText)
        self.__cb_format.set_active_id(self.__format)
        self.__cb_format.connect("changed", self.__on_combo_changed)
        ...
        accelgroup.connect(key, mod, Gtk.AccelFlags(0), self.__on_accel_activated)
    ...
    def __on_values_only_toggled(self, button: Gtk.CheckButton) -> None:
        ...
        self.__cb_format.set_active_id("plain")
