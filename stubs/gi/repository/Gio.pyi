...
class Cancellable(GObject.Object):
    ...
    def disconnect(self, handler_id: builtins.int) -> None: ...  # type: ignore
...
class DtlsClientConnection(GObject.GInterface):
    ...
    @staticmethod
    def new(base_socket: DatagramBased, server_identity: typing.Optional[SocketConnectable]) -> DtlsClientConnection: ...  # type: ignore
...
class DtlsServerConnection(GObject.GInterface):
    ...
    @staticmethod
    def new(base_socket: DatagramBased, certificate: typing.Optional[TlsCertificate]) -> DtlsServerConnection: ...  # type: ignore
...
class File(GObject.GInterface):
    ...
    def monitor_file(self, flags: FileMonitorFlags, cancellable: typing.Optional[Cancellable]) -> FileMonitor: ...
    ...
    def query_exists(self, cancellable: typing.Optional[Cancellable]) -> builtins.bool: ...
    ...
    def query_info(self, attributes: builtins.str, flags: FileQueryInfoFlags, cancellable: typing.Optional[Cancellable]) -> FileInfo: ...
...
class IOModule(GObject.TypeModule):
    ...
    @staticmethod
    def new(filename: builtins.str) -> IOModule: ...  # type: ignore
...
class Initable(GObject.GInterface):
    ...
    def init(self, cancellable: typing.Optional[Cancellable]) -> builtins.bool: ...
...
class TlsClientConnection(GObject.GInterface):
    ...
    @staticmethod
    def new(base_io_stream: IOStream, server_identity: typing.Optional[SocketConnectable]) -> TlsClientConnection: ...  # type: ignore
...
class TlsFileDatabase(GObject.GInterface):
    ...
    @staticmethod
    def new(anchors: builtins.str) -> TlsFileDatabase: ...  # type: ignore
...
class TlsServerConnection(GObject.GInterface):
    ...
    @staticmethod
    def new(base_io_stream: IOStream, certificate: typing.Optional[TlsCertificate]) -> TlsServerConnection: ...  # type: ignore
...
class SimpleIOStream(IOStream):
    ...
    @staticmethod
    def new(input_stream: InputStream, output_stream: OutputStream) -> IOStream: ...  # type: ignore
...
class DBusConnection(GObject.Object, AsyncInitable, Initable):
    ...
    def register_object(self, object_path: builtins.str, interface_info: DBusInterfaceInfo, method_call_closure: typing.Optional[GObject.Closure], get_property_closure: typing.Optional[GObject.Closure], set_property_closure: typing.Optional[GObject.Closure]) -> builtins.int: ...
    ...
    def signal_subscribe(self, sender: typing.Optional[builtins.str], interface_name: typing.Optional[builtins.str], member: typing.Optional[builtins.str], object_path: typing.Optional[builtins.str], arg0: typing.Optional[builtins.str], flags: DBusSignalFlags, callback: DBusSignalCallback, *user_data: typing.Optional[builtins.object]) -> builtins.int: ...
...
class DBusProxy(GObject.Object, AsyncInitable, DBusInterface, Initable):
    ...
    def call(self, method_name: builtins.str, parameters: typing.Optional[GLib.Variant], flags: DBusCallFlags, timeout_msec: builtins.int, cancellable: typing.Optional[Cancellable], callback: typing.Optional[AsyncReadyCallback], *user_data: typing.Optional[builtins.object]) -> None: ...
    ...
    @staticmethod
    def new_for_bus_sync(bus_type: BusType, flags: DBusProxyFlags, info: typing.Optional[DBusInterfaceInfo], name: builtins.str, object_path: builtins.str, interface_name: builtins.str, cancellable: typing.Optional[Cancellable]) -> DBusProxy: ...
    ...
    def do_g_properties_changed(self, changed_properties: GLib.Variant, invalidated_properties: builtins.str) -> None: ...
...
class SimplePermission(Permission):
    ...
    @staticmethod
    def new(allowed: builtins.bool) -> Permission: ...  # type: ignore
...
class UnixInputStream(InputStream, FileDescriptorBased, PollableInputStream):
    ...
    @staticmethod
    def new(fd: builtins.int, close_fd: builtins.bool) -> InputStream: ...  # type: ignore
...
class UnixOutputStream(OutputStream, FileDescriptorBased, PollableOutputStream):
    ...
    @staticmethod
    def new(fd: builtins.int, close_fd: builtins.bool) -> OutputStream: ...  # type: ignore
...
class MemoryInputStream(InputStream, PollableInputStream, Seekable):
    ...
    @staticmethod
    def new() -> InputStream: ...  # type: ignore
...
class UnixCredentialsMessage(SocketControlMessage):
    ...
    @staticmethod
    def new() -> SocketControlMessage: ...  # type: ignore
...
class BufferedInputStream(FilterInputStream, Seekable):
    ...
    @staticmethod
    def new(base_stream: InputStream) -> InputStream: ...  # type: ignore
...
class ConverterInputStream(FilterInputStream, PollableInputStream):
    ...
    @staticmethod
    def new(base_stream: InputStream, converter: Converter) -> InputStream: ...  # type: ignore
...
class BufferedOutputStream(FilterOutputStream, Seekable):
    ...
    @staticmethod
    def new(base_stream: OutputStream) -> OutputStream: ...  # type: ignore
...
class ConverterOutputStream(FilterOutputStream, PollableOutputStream):
    ...
    @staticmethod
    def new(base_stream: OutputStream, converter: Converter) -> OutputStream: ...  # type: ignore
...
class DataOutputStream(FilterOutputStream, Seekable):
    ...
    @staticmethod
    def new(base_stream: OutputStream) -> DataOutputStream: ...  # type: ignore
...
class InetSocketAddress(SocketAddress):
    ...
    @staticmethod
    def new(address: InetAddress, port: builtins.int) -> SocketAddress: ...  # type: ignore
...
class NativeSocketAddress(SocketAddress):
    ...
    @staticmethod
    def new(native: typing.Optional[builtins.object], len: builtins.int) -> SocketAddress: ...  # type: ignore
...
class UnixSocketAddress(SocketAddress):
    ...
    @staticmethod
    def new(path: builtins.str) -> SocketAddress: ...  # type: ignore
...
class TcpWrapperConnection(TcpConnection):
    ...
    @staticmethod
    def new(base_io_stream: IOStream, socket: Socket) -> SocketConnection: ...  # type: ignore
...
class DataInputStream(BufferedInputStream):
    ...
    @staticmethod
    def new(base_stream: InputStream) -> DataInputStream: ...  # type: ignore
...
class FileAttributeInfoList():
    ...
    @staticmethod
    def new() -> FileAttributeInfoList: ...  # type: ignore
...
class FileAttributeMatcher():
    ...
    @staticmethod
    def new(attributes: builtins.str) -> FileAttributeMatcher: ...  # type: ignore
...
class SrvTarget():
    ...
    @staticmethod
    def new(hostname: builtins.str, port: builtins.int, priority: builtins.int, weight: builtins.int) -> SrvTarget: ...  # type: ignore
...
DBusInterfaceMethodCallFunc = typing.Callable[[DBusConnection, builtins.str, builtins.str, builtins.str, builtins.str, GLib.Variant, DBusMethodInvocation, typing.Optional[builtins.object]], None]
...
def bus_get_sync(bus_type: BusType, cancellable: typing.Optional[Cancellable]) -> DBusConnection: ...
...
def bus_watch_name(bus_type: BusType, name: builtins.str, flags: BusNameWatcherFlags, name_appeared_closure: typing.Optional[GObject.Closure], name_vanished_closure: typing.Optional[GObject.Closure]) -> builtins.int: ...
