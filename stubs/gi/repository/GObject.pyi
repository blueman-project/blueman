...
class GType():
    ...
    def has_value_table(*args, **kwargs): ...

    def is_a(*args, **kwargs): ...

    def is_abstract(*args, **kwargs): ...

    def is_classed(*args, **kwargs): ...

    def is_deep_derivable(*args, **kwargs): ...

    def is_derivable(*args, **kwargs): ...

    def is_instantiatable(*args, **kwargs): ...

    def is_interface(*args, **kwargs): ...

    def is_value_abstract(*args, **kwargs): ...

    def is_value_type(*args, **kwargs): ...
...
class Object():
    ...
    def connect(self, detailed_signal: builtins.str, handler: function, *args: typing.Any) -> builtins.int: ...
...
class ParamSpecPool():
    ...
    @staticmethod
    def new(type_prefixing: builtins.bool) -> ParamSpecPool: ...  # type: ignore
...
class ValueArray():
    ...
    @staticmethod
    def new(n_prealloced: builtins.int) -> ValueArray: ...  # type: ignore
...
Warning: typing.Any
features: builtins.dict
glib_version: builtins.tuple
pygobject_version: builtins.tuple
