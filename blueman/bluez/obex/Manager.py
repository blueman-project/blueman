...
class Manager(GObject.GObject, metaclass=SingletonGObjectMeta):
    ...
    def __init__(self) -> None:
        ...
        self._object_manager = Gio.DBusObjectManagerClient.new_for_bus_sync(
            Gio.BusType.SESSION, Gio.DBusObjectManagerClientFlags.NONE, self.__bus_name, "/", None, None, None
        )
    ...
    def watch_name_owner(
        ...
        Gio.bus_watch_name(
            Gio.BusType.SESSION, cls.__bus_name, Gio.BusNameWatcherFlags.AUTO_START, appeared_handler, vanished_handler
        )
