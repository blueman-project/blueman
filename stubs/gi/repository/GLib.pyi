...
class ByteArray():
    ...
    @staticmethod
    def new() -> builtins.bytes: ...  # type: ignore
...
class Bytes():
    ...
    @staticmethod
    def new(data: typing.Optional[builtins.bytes]) -> Bytes: ...  # type: ignore
...
class Checksum():
    ...
    @staticmethod
    def new(checksum_type: ChecksumType) -> Checksum: ...  # type: ignore
...
class DateTime():
    ...
    @staticmethod
    def new(tz: TimeZone, year: builtins.int, month: builtins.int, day: builtins.int, hour: builtins.int, minute: builtins.int, seconds: builtins.float) -> DateTime: ...  # type: ignore
...
class IOChannel():
    ...
    def read(self, buf: builtins.str, count: builtins.int, bytes_read: builtins.int) -> IOError: ...
...
class MainContext():
    ...
    @staticmethod
    def new() -> MainContext: ...  # type: ignore
...
class MainLoop():
    ...
    @staticmethod
    def new(context: typing.Optional[MainContext], is_running: builtins.bool) -> MainLoop: ...  # type: ignore
...
class MappedFile():
    ...
    @staticmethod
    def new(filename: builtins.str, writable: builtins.bool) -> MappedFile: ...  # type: ignore
...
class MarkupParseContext():
    ...
    @staticmethod
    def new(parser: MarkupParser, flags: MarkupParseFlags, user_data: typing.Optional[builtins.object], user_data_dnotify: DestroyNotify) -> MarkupParseContext: ...  # type: ignore
...
class OptionGroup():
    ...
    @staticmethod
    def new(name: builtins.str, description: builtins.str, help_description: builtins.str, user_data: typing.Optional[builtins.object], destroy: typing.Optional[DestroyNotify]) -> OptionGroup: ...  # type: ignore
...
class Regex():
    ...
    @staticmethod
    def new(pattern: builtins.str, compile_options: RegexCompileFlags, match_options: RegexMatchFlags) -> typing.Optional[Regex]: ...  # type: ignore
...
class Source():
    ...
    @staticmethod
    def new(source_funcs: SourceFuncs, struct_size: builtins.int) -> Source: ...  # type: ignore
...
class TimeZone():
    ...
    @staticmethod
    def new(identifier: typing.Optional[builtins.str]) -> TimeZone: ...  # type: ignore
...
class Variant():
    ...
    def split_signature(*args, **kwargs): ...
...
class VariantBuilder():
    ...
    @staticmethod
    def new(type: VariantType) -> VariantBuilder: ...  # type: ignore
...
class VariantDict():
    ...
    @staticmethod
    def new(from_asv: typing.Optional[Variant]) -> VariantDict: ...  # type: ignore
...
class VariantType():
    ...
    @staticmethod
    def new(type_string: builtins.str) -> VariantType: ...  # type: ignore
...
def idle_add(priority: builtins.int, function: SourceFunc, *data: typing.Optional[builtins.object]) -> builtins.int: ...
...
def io_add_watch(channel: typing.Any, priority: typing.Any, condition: typing.Any, func: typing.Any, *user_data: typing.Any) -> event_source_id: ...
...
def timeout_add(priority: builtins.int, interval: builtins.int, function: SourceFunc, *data: typing.Optional[builtins.object]) -> builtins.int: ...


def timeout_add_seconds(priority: builtins.int, interval: builtins.int, function: SourceFunc, *data: typing.Optional[builtins.object]) -> builtins.int: ...
...
glib_version: builtins.tuple
pyglib_version: builtins.tuple
