...
class DrawingContext(GObject.Object):
    ...
    def get_cairo_context(self) -> "BaseContext": ...
...
class Window(GObject.Object):
    ...
    def mark_paint_from_clip(self, cr: "BaseContext") -> None: ...
...
def cairo_create(window: Window) -> "BaseContext": ...


def cairo_draw_from_gl(cr: "BaseContext", window: Window, source: builtins.int, source_type: builtins.int, buffer_scale: builtins.int, x: builtins.int, y: builtins.int, width: builtins.int, height: builtins.int) -> None: ...


def cairo_get_clip_rectangle(cr: "BaseContext") -> typing.Tuple[builtins.bool, Rectangle]: ...


def cairo_get_drawing_context(cr: "BaseContext") -> typing.Optional[DrawingContext]: ...


def cairo_rectangle(cr: "BaseContext", rectangle: Rectangle) -> None: ...


def cairo_region(cr: "BaseContext", region: cairo.Region) -> None: ...


def cairo_region_create_from_surface(surface: cairo.Surface) -> cairo.Region: ...


def cairo_set_source_color(cr: "BaseContext", color: Color) -> None: ...


def cairo_set_source_pixbuf(cr: "BaseContext", pixbuf: GdkPixbuf.Pixbuf, pixbuf_x: builtins.float, pixbuf_y: builtins.float) -> None: ...


def cairo_set_source_rgba(cr: "BaseContext", rgba: RGBA) -> None: ...


def cairo_set_source_window(cr: "BaseContext", window: Window, x: builtins.float, y: builtins.float) -> None: ...
