...
class _NotificationDialog(Gtk.MessageDialog):
    def __init__(
        ...
        actions_cb: Optional[Callable[[str], None]] = None,
        icon_name: Optional[str] = None,
        image_data: Optional[GdkPixbuf.Pixbuf] = None,
    ) -> None:
        super().__init__(parent=None, type=Gtk.MessageType.QUESTION, buttons=Gtk.ButtonsType.NONE, text=None)
...
def Notification(
    ...
    icon_name: Optional[str] = None,
    image_data: Optional[GdkPixbuf.Pixbuf] = None,
) -> Union[_NotificationBubble, _NotificationDialog]:
